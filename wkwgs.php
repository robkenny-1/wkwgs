...
function Wkwgs_noticePhpVersionWrong()
{
    ...
    echo '<div class="updated fade">' .
      __('Error: plugin "wkwgs" requires a newer version of PHP to be running.',  'wkwgs').
            '<br/>' . __('Minimal version of PHP required: ', 'wkwgs') . '<strong>' . $Wkwgs_minimalRequiredPhpVersion . '</strong>' .
            '<br/>' . __('Your server\'s PHP version: ', 'wkwgs') . '<strong>' . phpversion() . '</strong>' .
         '</div>';
}
