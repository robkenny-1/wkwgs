...
include_once ('Wkwgs_InstallIndicator.php');

class Wkwgs_LifeCycle extends Wkwgs_InstallIndicator
{
    ...
    /**
     * Perform any version-upgrade activities prior to activation (e.g.
     * database changes)
     *
     * @return void
     */
     ...
     *            the name of the ajax action registered in a call like
