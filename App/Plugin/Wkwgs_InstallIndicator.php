...
include_once ('Wkwgs_OptionsManager.php');

class Wkwgs_InstallIndicator extends Wkwgs_OptionsManager
{
     ...
     * This is useful if you install upgrade and
     ...
     *            best practice: use a dot-delimited string like '1.2.3' so version strings can be easily
     ...
     * override this method with the exact same code.
     * Since __FILE__ will
     ...
     * This case indicates that an upgrade has been installed and this is the first time it
     ...
     *            a version string such as '1', '1.1', '1.1.1', '2.0', etc.
