...
abstract class Wkwgs_ShortCodeLoader
{

    /**
     *
     * @param $shortcodeName mixed
     *            either string name of the shortcode
     ...
     *            name of public function in this class to call as the
     *            shortcode handler
     * @return void
     */
